...
import Blog3 from "../img/portfolio-01.jpeg"
import Blog4 from "../img/portfolio-01.jpeg"
const Blog = () => {
  return (
    <div>
         <div className="blog-section section">
            ...
            <div className="blog content">
                ...
                <div className="grid2">
                    <div className="blog-subsection">
                        <div className="img-txt flex">
                            <img className="border-radius-bottom img-50" src={Blog3} alt=""/>
                ...
                <div className="grid3">
                    <div className="blog-subsection">
                        <div className="img-txt flex">
                            <img className="border-radius-bottom img-50" src={Blog4} alt=""/>
                            <div className="txt-with-img">
                                <div className="btn-date flex">
                                    <button className="seo btnHover">SEO analysis</button>
                                    <div className="date">03 August 2021</div>
